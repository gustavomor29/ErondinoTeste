...
local itemPedra = { 
    ...
    -- [STONE_ID] = {pokemons que usam a stone} 
                    --[[Fire]]     
		    [2283] = {names = "Typhlosion,Slugma,Quilava,Magcargo,Magcarbo,Magby,Houndour,Houndoom,Ho oh,Entei,Cyndaquil,Charmander, Charizard, Charmileon, Arcanine, Growlithe, Flareon, Magmar, Ninetales, Rapidash, Vulpix, Ponyta, Moltres, Shiny Arcanine, Elder Charizard, Shiny Growlithe" ,count = 2}, 
		    --[[Crystal]]  
		    ...
		    --[[Heart]]    
		    [2289] = {names =  "Wobbuffet,Ursaring,Togetic,Togepi,Teddiursa,Stantler,Snubbull,Smeargle,Sentret,Porygon2,Noctowl,Miltank,Igglybuff,Hoothoot,Granbull,Furret,Delibird,Cleffa,Blissey,   Pidgeot, Pidgeotto, Fearow, Pidgey, Chansey, Clefable, Wiglyttuff, Kangaskhan, Porygon, Raticate, Rattata, Doduo, Dodrio, Spearow, Clefairy, Jigglypuff, Meowth, Persian, Farfetchd, Lickitung, Ditto, Eevee, Snorlax, Shiny Pidgeot, Shiny Rattata, Shiny Raticate,Elite Farfetchd,Aipom" ,count = 2}, 
		    --[[Darkness]] 
...
--[[Boost]]    
		    [2154] = {names =  "Swinub,Sneasel,Smoochum,Piloswine,Seel, Jynx, Dewgong, Cloyster, Shellder, Articuno, Shiny Jynx" ,count = 1} ,
	...
	if getDistanceToCreature(cid) > 4 then
	  ...
	  if talkState[talkUser] ~= 3 then
		...
		elseif ( msgcontains(msg, 'yes') and talkState[talkUser] == 2 ) then
				stones = getPlayerStorageValue(cid, 18060)
