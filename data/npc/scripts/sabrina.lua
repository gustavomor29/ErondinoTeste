...
if getPlayerStorageValue(cid, ginasios["Sabrina"].storage) >= 1 then
return true
end
...
selfSay("Bem vindo ao ginasio de Saffron City. Meu nome é Sabrina diga BATTLE para começar o duelo comigo está afim?")
...
doGymBattle("Sabrina", "Sabrina Kadabra", cid, 1)
setPlayerStorageValue(cid, ginasios["Sabrina"].storage, 1)
