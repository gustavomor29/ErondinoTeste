...
if getPlayerStorageValue(cid, ginasios["Erika"].storage) >= 1 then
return true
end
...
selfSay("Bem vindo ao ginasio de Celadon City. Meu nome é Erika diga BATTLE para começar o duelo comigo está afim?")
...
doGymBattle("Erika", "Erika Tangela", cid, 1)
