...
if getPlayerStorageValue(cid, ginasios["Blaine"].storage) >= 1 then
return true
end
...
selfSay("Bem vindo ao ginasio de Ilha cinnabar. Meu nome é Blaine diga BATTLE para começar o duelo comigo está afim?")
...
doGymBattle("Blaine", "Blaine Ninetales", cid, 1)
setPlayerStorageValue(cid, ginasios["Blaine"].storage, 1)
