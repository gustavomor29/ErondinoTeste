...
if getPlayerStorageValue(cid, ginasios["Giovanni"].storage) >= 1 then
return true
end
...
selfSay("Bem vindo ao ginasio de Fuschia City. Meu nome é Koga diga BATTLE para começar o duelo comigo está afim?")
...
doGymBattle("Giovanni", "Giovanni Persian", cid, 1)
setPlayerStorageValue(cid, ginasios["Giovanni"].storage, 1)
