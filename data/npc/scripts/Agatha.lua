...
if getPlayerStorageValue(cid, ginasios["Agatha"].storage) >= 1 then
return true
end
...
selfSay("Bem vindo ao ginasio de Viridian City. Meu nome é Agatha diga BATTLE para começar o duelo comigo está afim?")
...
doGymBattle("Agatha", "Agatha Gengar", cid, 1)
setPlayerStorageValue(cid, ginasios["Agatha"].storage, 1)
