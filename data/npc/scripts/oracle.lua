...
{1,'Saffron', 1052, 1050, 7, 'free'},
{2,'Cerulean',1059,904,7,'free'},
{4,'Fuchsia',1122,1449,7,'free'},
{5,'Celadon',862,1035,6,'free'},
{6,'Viridian',634,1345,7,'free'},
{8,'Cinnabar', 572, 669, 6, 'free'},
{9,'Vermilion',1072,1238,7,'free'},
{10,'Pallet',576,1143,7,'free'},
},
Vocations = { -- {[id] = 'nome'}
[1] = 'Pokemon Trainer'
},
...
hi = 'Entao, sua mae lhe mandou aqui para falar sobre pokemons?',
askVoc = 'Pokemons sao monstros que vivem em nosso mundo por mundo tempo, existem diferentes teorias sobre como eles vieram para aqui, porem se adaptaram muito bem e sao criaturas muito doceis se tratadas com carinho e respeito. Quem treina pokemons e chamado Pokemon Trainer, vc quer se tornar um ',
confirmVoc = 'Esse e um caminho sem volta meu rapaz vc tem certeza?',
askCity = 'Onde voce quer iniciar sua jornada, em ',
final = 'Boa sorte pequeno Treinador!',
bye = 'Fale comigo quando estiver pronto.'
},
talkStorage = 7897,
choos = {},
citiesLiberadas = {}
