...
selfSay('So, i think you deserve this, would you accept my {Golem} as a gift?')
...
talkState[talkUser] = 2
 ...
 local health = 620
        ...
        doPlayerSendTextMessage(cid, 27, "Daifray has given you an Golem.")
        setPlayerStorageValue(cid, 209911, 1)
        else
        ...
        doPlayerSendTextMessage(cid, 27, "Daifray has given you an Golem.")
        doPlayerSendTextMessage(cid, 27, "Since you are already holding six pokemons, this Golem has been sent to your depot.")
	    end
