...
selfSay('So, i think you deserve this, would you accept my {Onix} as a gift?')
...
talkState[talkUser] = 2
 ...
 local health = 620
        ...
        doPlayerSendTextMessage(cid, 27, "Federkis has given you an Onix.")
        setPlayerStorageValue(cid, 209913, 1)
        else
        ...
        doPlayerSendTextMessage(cid, 27, "Brander has given you an Onx.")
        doPlayerSendTextMessage(cid, 27, "Since you are already holding six pokemons, this Onix has been sent to your depot.")
	    end
