...
selfSay("Oi meu nome é falkner, so lider do ginasio da cidade de violet esta afim de uma batalha?")
...
doGymBattle("falkner", "falkner Pidgeot", cid, 1)
setPlayerStorageValue(cid, ginasios["falkner"].storage, 1)
