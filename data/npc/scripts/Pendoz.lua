...
selfSay('So, i think you deserve this, would you accept my {Raichu} as a gift?')
...
talkState[talkUser] = 2
 ...
 local health = 620
        ...
        doPlayerSendTextMessage(cid, 27, "Pendoz has given you an Raichu.")
        setPlayerStorageValue(cid, 209912, 1)
        else
        ...
        doPlayerSendTextMessage(cid, 27, "Pendoz has given you an Raichu.")
        doPlayerSendTextMessage(cid, 27, "Since you are already holding six pokemons, this Raichu has been sent to your depot.")
	    end
