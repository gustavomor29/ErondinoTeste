...
selfSay("Oi meu nome é Whitney, so lider do ginasio da cidade de goldenrod esta afim de uma batalha?")
...
doGymBattle("whitney", "whitney miltank", cid, 1)
setPlayerStorageValue(cid, ginasios["whitney"].storage, 1)
