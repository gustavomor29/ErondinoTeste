...
if getPlayerStorageValue(cid, 209914) <= 0 then
selfSay('So, i think you deserve this, would you accept my {Charmeleon} as a gift?')
...
talkState[talkUser] = 2
 ...
 local health = 620
        ...
        doPlayerSendTextMessage(cid, 27, "Brander has given you an Charmelon.")
        setPlayerStorageValue(cid, 209914, 1)
        else
        ...
        doPlayerSendTextMessage(cid, 27, "Brander has given you an Charmeleon.")
        doPlayerSendTextMessage(cid, 27, "Since you are already holding six pokemons, this charmeleon has been sent to your depot.")
	    end
