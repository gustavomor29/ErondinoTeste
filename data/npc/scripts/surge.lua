...
if getPlayerStorageValue(cid, ginasios["Surge"].storage) >= 1 then
return true
end
...
selfSay("Bem vindo ao ginasio de Vermillion City. Meu nome é Surge diga BATTLE para começar o duelo comigo está afim?")
...
doGymBattle("Surge", "Surge Raichu", cid, 1)
setPlayerStorageValue(cid, ginasios["Surge"].storage, 1)
