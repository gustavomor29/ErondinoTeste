...
if getPlayerStorageValue(cid, ginasios["Kyra"].storage) >= 1 then
return true
end
...
selfSay("Welcome to the gym of Pewter City. My name is Kyra and I am the leader of this gym. Would you like to battle me?")
...
doGymBattle("Kyra", "Kyra Jinx", cid, 1)
setPlayerStorageValue(cid, ginasios["Kyra"].storage, 1)
setPlayerStorageValue(cid, 997, 0)
