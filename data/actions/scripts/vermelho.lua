...
addOutfitCondition(bikeCondition, {lookType = 263, lookHead = 132, lookBody = 132, lookLegs = 132, lookFeet = 132})
local t = {
	[1435] = {article='a' ,name='Team Vermelho', text='Go team', dtext='To saindo', s=10, condition=bikeCondition},
}
