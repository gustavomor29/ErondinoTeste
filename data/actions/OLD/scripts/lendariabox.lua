...
r1 = math.random(1,11)
if getPlayerLevel(cid) >= 200 and getPlayerFreeCap(cid) ~= 0 then
if doPlayerRemoveItem(cid,2135,1) == TRUE then
if r1 == 1 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Celebi.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Celebi."
local poke1 = "This is Celebi's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Celebi")
...
elseif r1 == 2 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Articuno.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Articuno."
local poke1 = "This is Articuno's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Articuno")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 3 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Zapdos.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Zapdos."
local poke1 = "This is Zapdos's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Zapdos")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 4 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Entei.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Entei."
local poke1 = "This is Entei's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Entei")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 5 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Mew.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Mew."
local poke1 = "This is Mew's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Mew")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 6 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Moltres.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Moltres."
local poke1 = "This is Moltres's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Moltres")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 7 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Mewtwo.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Mewtwo."
local poke1 = "This is Mewtwo's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Mewtwo")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 8 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Ho oh.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Ho oh."
local poke1 = "This is Ho oh's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Ho oh")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 9 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Lugia.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Lugia."
local poke1 = "This is Lugia's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Lugia")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 10 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Suicune.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Suicune."
local poke1 = "This is Suicune's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Suicune")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
elseif r1 == 11 then
doPlayerSendTextMessage(cid,22,"Você ganhou um Raikou.")
local health = 6000 -- Health do poke
local maxhealth = 6000 -- Maximo de health do poke
local description = "Contains a Raikou."
local poke1 = "This is Raikou's pokeball. HP = ["..health.."/"..maxhealth.."]"
item = doCreateItemEx(2219)
doItemSetAttribute(item, "poke", poke1)
doItemSetAttribute(item, "nome", "Raikou")
doItemSetAttribute(item, "description", description)
doPlayerAddItemEx(cid, item, true)
doTransformItem(item, 2222)
doSendMagicEffect(getCreaturePosition(cid), 28)
...
doSendMagicEffect(getCreaturePosition(cid), 29)
  ...
  doPlayerSendCancel(cid,'Somente players level 180+ e que estejam carregando 5 ou menos pokemons podem abrir este presente.')
        end
return 1
end