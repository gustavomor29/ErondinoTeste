function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	elseif (item.actionid == 42365 and getPlayerStorageValue(cid,42351) == 1) then
		if cidPosition.x < toPosition.x then
			doTeleportThing(cid, {x=toPosition.x+1,y=toPosition.y,z=toPosition.z}, TRUE)
		else
			doTeleportThing(cid, {x=toPosition.x-1,y=toPosition.y,z=toPosition.z}, TRUE)
		...
		doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "Primeiro converse com o npc, depois podera entrar.")
		return TRUE
	end
	return FALSE
end