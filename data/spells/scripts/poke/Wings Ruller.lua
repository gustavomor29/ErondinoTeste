local combata, effect, area, words, dir = {}, {250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250, 250}, {
...
for i = 1, 12 do
        ...
        setCombatParam(combata[i], COMBAT_PARAM_TYPE, FLYDAMAGE)
...
function onCastSpell(cid, var)
		doCreatureSay(cid, "Wings Ruller!", TALKTYPE_MONSTER)
