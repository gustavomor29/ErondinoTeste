...
function onCastSpell(cid, var)
	doCreatureSay(cid, "Dark Cannon!", TALKTYPE_MONSTER)
...
if getCreatureName(cid) == "Blastoise" or getCreatureName(cid) == "Misdreavus" then
jjj = 690
else
jjj = 550
end
local j = jjj
		...
		doAreaCombatHealth(cid, GHOSTDAMAGE, params.ar, whirl3, -(j), -(j+120), 222)
		doAreaCombatHealth(cid, null, params.arr, whirl3, -0, -0, 222)
		else
		end
		end
