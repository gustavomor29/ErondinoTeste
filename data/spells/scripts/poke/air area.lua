...
setCombatParam(combat, COMBAT_PARAM_TYPE, FLYDAMAGE)
...
function onCastSpell(cid, var)
	doCreatureSay(cid, "AIR AREA!", TALKTYPE_MONSTER)
...
local function gas(params)
	...
	doAreaCombatHealth(cid, FLYDAMAGE, getThingPos(cid), area, -(params.x), -(params.y), 114)
	end
	end
if getCreatureName(cid) == "Xatu" then
min = 5
