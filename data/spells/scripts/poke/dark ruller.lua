...
setCombatParam(combat1, COMBAT_PARAM_TYPE, COMBAT_GHOSTDAMAGE)
setCombatParam(combat1, COMBAT_PARAM_EFFECT, 223)
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -0.6, -30, -1.2, 0)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_GHOSTLDAMAGE)setCombatParam(combat2, COMBAT_PARAM_EFFECT, 223)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -0.6, -30, -1.2, 0)

local combat3 = createCombatObject()
setCombatParam(combat3, COMBAT_PARAM_TYPE, COMBAT_GHOSTDAMAGE)
setCombatParam(combat3, COMBAT_PARAM_EFFECT, 223)
...
doCreatureSay(cid, "BUG RULLER!", TALKTYPE_MONSTER)
